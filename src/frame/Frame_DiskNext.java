...
public class Frame_DiskNext extends javax.swing.JFrame {
     ...
     * @param diskList 
     */
    public Frame_DiskNext(List<ProductDTO> diskList) {
    ...
    private void initComponents() {
        ...
        ImageIcon icon3 = new ImageIcon(getClass().getResource("/images/Disk/Crucial P5Plus.jpeg"));
        ...
        ImageIcon icon4 = new ImageIcon(getClass().getResource("/images/Disk/Seagate Barracuda 4TB.jpeg"));
        ...
        ImageIcon icon5 = new ImageIcon(getClass().getResource("/images/Disk/Samsung 870 EVO.jpeg"));
        ...
        ProductDTO showProduct = diskList.remove(0);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Frame_DiskNext frame_DiskNext = new Frame_DiskNext(null);
				frame_DiskNext.setVisible(true);
            }
        });
    }
    ...
    private List<ProductDTO> diskList = null;
